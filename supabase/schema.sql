...
-- TABLE ORDER MATTERS: locations → equipment → events → ...
-- ============================================================
...
create policy "allow_all_ev_eq"       on event_equipment    for all using (true) with check (true);
